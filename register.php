                        ...
                        <div class="carousel-inner" role="listbox">
                            ...
                            <div class="carousel-content2">
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="n" id="n" class="form-control" placeholder="Name" required /> <br />   
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <input type="password" name="p" id="p" class="form-control" placeholder="Confirm Password" /> <br />  
                                        </div>
